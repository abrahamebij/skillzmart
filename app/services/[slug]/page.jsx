...
const page = () => {
  return (
    <div className="w-full h-max lg:min-h-[calc(100vh-64px)] overflow-hidden">
      <div className="w-full lg:w-full h-auto lg:h-[70vh] bg-neutral-400 overflow-auto lg:overflow-hidden">
        <div className="w-max lg:w-full h-auto lg:h-full grid grid-cols-5 lg:grid-cols-4 gap-5">
          ...
          <Image
            ...
            width={300}
            height={300}
            className="w-full h-full  object-cover rounded-md lg:col-start-2 lg:col-span-2 lg:row-span-2"
          />
          <Image
            src={house1}
            width={300}
      ...
      <div className="p-5 md:p-10 lg:p-10 px-5 md:px-16 lg:px-24 text-blue-950 font-sans grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="col-span-1 lg:col-span-2 lg:pr-32 order-last lg:order-first">
          ...
          <p className="tx-base lg:text-sm mb-5">
            Works professionally with differnt types of paint, ranging from
            Emulsion, Gloss, Acrylic, Enamel, Satin etc... and also Wallpapers.
          </p>
          ...
          <div className="my-2 flex flex-row items-center gap-5 text-yellow-500">
          ...
          <p className="my-2 text-xl font-semibold mt-8">Related searches</p>
          <div></div>
        </div>
