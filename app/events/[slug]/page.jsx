...
import flyer from "@/app/public/flyer3.jpg";
import Img from "../../components/Img";

const page = () => {
  return (
    <div className="w-full h-auto lg:min-h-[calc(100vh-64px)]">
      <div className="w-full h-[50vh] md:w-1/3 md:h-[65vh] md:rounded-lg  bg-neutral-400 overflow-hidden mx-auto mt-10">
        <Img src={flyer} alt={"Flyer Picture"} />
      </div>
      <div className="p-5 md:p-10 lg:p-20 px-5 md:px-16 lg:px-24 text-blue-950 font-sans grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="col-span-1 lg:col-span-2 lg:pr-32 order-last lg:order-first">
          <p className="font-semibold ">11th September, 1945</p>
          ...
          <div className="font-semibold mt-8">
            ...
            <p className="my-2">
              ...
              <span className="font-normal">
                {" "}
                Abraham lincoln School, Fashina Ibogun
              </span>
            </p>
          </div>
        </div>
